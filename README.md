...
While quantum wavefunctions are usually described by a probability density $\Psi(x)$, these QMC methods use an explicit set of samples of the many-body wavefunction. Furthermore, the basis used may be highly constrained and require special treatment, such is the case in AFDMC. 
